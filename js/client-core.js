...
function PSSubscription(observable,listener){
...
var PSBackground=new(_temp=function(_PSStreamModel){_inheritsLoose(_temp,_PSStreamModel);
...
}var _proto4=_temp.prototype;_proto4.
...
h/=6;
return h*360+","+s*100+"%";
};return _temp;}(PSStreamModel),_temp)();
