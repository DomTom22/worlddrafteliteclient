...
linkStyle('https://prismaticshowdown.herokuapp.com//style/font-awesome.css?');
linkStyle('https://prismaticshowdown.herokuapp.com//style/battle.css?a7');
linkStyle('https://prismaticshowdown.herokuapp.com//style/replay.css?a7');
linkStyle('https://prismaticshowdown.herokuapp.com//style/utilichart.css?a7');

requireScript('https://prismaticshowdown.herokuapp.com//js/lib/ps-polyfill.js');
requireScript('https://prismaticshowdown.herokuapp.com//config/config.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//js/lib/jquery-1.11.0.min.js');
requireScript('https://prismaticshowdown.herokuapp.com//js/lib/lodash.compat.js');
requireScript('https://prismaticshowdown.herokuapp.com//js/lib/html-sanitizer-minified.js');
requireScript('https://prismaticshowdown.herokuapp.com//js/battle-sound.js');
requireScript('https://prismaticshowdown.herokuapp.com//js/battledata.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//data/pokedex-mini.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//data/pokedex-mini-bw.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//data/graphics.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//data/pokedex.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//data/moves.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//data/abilities.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//data/items.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//data/teambuilder-tables.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//data/mod-sprites.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//data/mod-config.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//js/battle-tooltips.js?a7');
requireScript('https://prismaticshowdown.herokuapp.com//js/battle.js?a7');
