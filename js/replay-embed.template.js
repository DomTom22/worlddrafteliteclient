...
var Replays = {
	...
	update: function (state) {
		...
		if (this.battle.paused && this.battle.turn <= 0) {
			this.$('.replay-controls').html('<button data-action="play"><i class="fa fa-play"></i> Play</button><button data-action="reset" disabled="disabled"><i class="fa fa-undo"></i> Reset</button>');
